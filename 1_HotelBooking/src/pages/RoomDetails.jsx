...
const RoomDetails = () => {
 ...
 {/*Check In Check Out Form */ }
      <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
        ...
        <div className='flex flex-col flex-wrap md:flex-row items-start md:tems-center gap-4 md:gap-10 text-gray-500'>
          <div className='flex flex-col'>
 ...
 <div className='w-px h-15 bg-gray-300/70 max-md:hidden '></div>
   ...
   <div className='flex flex-col'>
          ...
          <button type='submit'  className='bg-orange-500 text-black px-6 py-3 rounded-md'>
Check Avalability 
</button>
              </form>
              ...
              <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
                <p>
                  Guests will be allocated on the ground floor according to Avalability.
                  You get a comfortable Two bedroom apartment has a true ity feeling .the price quote is to for guest, at the the guest will allocate this ....
                </p>
              </div>
              ...
              <div className='flex flex-col items-start gap-4 '>
                ...
                <button className='px-6 py-2.5 mt-4 rounded text-white bg-blue-600'>Contact Now</button>
